					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a href="{{route('dasadmin')}}"><i class="fa fa-home"></i> Home </a>
									
								</li>
									<li><a><i class="fa fa-table"></i> Tabel <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
											<li><a href="{{url('/dataorder')}}">Data Order</a></li>
											<li><a href="{{url('/datacrew')}}">Data Crew</a></li>
											<li><a href="{{url('/datalabor')}}">Data Labor</a></li>
										</ul>
									</li>
								</li>
								<li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{url('/insertorder')}}">Add Order</a></li>
										<li><a href="{{url('/forminsert')}}">Add Crew & Labor</a></li>
									</ul>
								</li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Setting"
							onclick="event.preventDefault();
											document.getElementById('gantipass-form').submit();">
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								<div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
									...
									<form id="gantipass-form" action="{{ route('gantipassadmin') }}" method="GET" class="d-none">
										@csrf
									</form>
								</div>
							</li>	
